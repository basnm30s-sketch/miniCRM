...
describe('Vehicle Finances Dashboard Metrics', () => {
    ...
    describe('getDashboardMetrics()', () => {
        it('should return dashboard metrics structure', () => {
            ...
            sqlite_1.vehicleTransactionsAdapter.getDashboardMetrics.mockReturnValue(mockMetrics);
            const metrics = sqlite_1.vehicleTransactionsAdapter.getDashboardMetrics();
        ...
        it('should handle errors gracefully', () => {
            ;
            sqlite_1.vehicleTransactionsAdapter.getDashboardMetrics.mockImplementation(() => {
                throw new Error('Database error');
            });
            expect(() => {
                sqlite_1.vehicleTransactionsAdapter.getDashboardMetrics();
