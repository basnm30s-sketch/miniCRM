...
class ClientSideExcelRenderer {
    ...
    async loadImageAsBuffer(imageUrl) {
        ...
        try {
            ...
            if (imageUrl.startsWith('data:')) {
                ...
                if (base64Match) {
                    extension = (base64Match[1] === 'jpg' ? 'jpeg' : base64Match[1]);
    ...
    applyCellStyle(cell, style) {
        ...
        if (style.fontSize !== undefined)
            cell.font = { ...cell.font, size: style.fontSize };
        if (style.fill)
...
exports.ClientSideExcelRenderer = ClientSideExcelRenderer;
// Export a singleton instance
exports.excelRenderer = new ClientSideExcelRenderer();
