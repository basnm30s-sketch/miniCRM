...
describe('Document Renderers', () => {
    ...
    describe('Excel Renderer', () => {
        const renderer = new excel_1.ClientSideExcelRenderer();
    ...
    describe('DOCX Renderer', () => {
        const renderer = new docx_1.ClientSideDOCXRenderer();
        it('should result in a Blob for Quote', async () => {
    ...
    describe('PDF Renderer (terms defaults)', () => {
        ...
        it('uses invoice-specific default terms when invoice.terms is empty', () => {
            ...
            const html = renderer.buildInvoiceHtml(invoice, admin, { name: 'Client A' }, {
                logoUrl: null,
                sealUrl: null,
                signatureUrl: null,
            });
