...
describe('API Client', () => {
    ...
    describe('Admin Settings', () => {
        it('should get admin settings successfully', async () => {
            ...
            const { getAdminSettings } = await Promise.resolve().then(() => __importStar(require('../api-client')));
            const result = await getAdminSettings();
            expect(result).toEqual(mockSettings);
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/admin/settings'), expect.objectContaining({
        ...
        it('should save admin settings successfully', async () => {
            ...
            const { saveAdminSettings } = await Promise.resolve().then(() => __importStar(require('../api-client')));
    ...
    describe('Customers', () => {
        it('should get all customers successfully', async () => {
            ...
            const { getAllCustomers } = await Promise.resolve().then(() => __importStar(require('../api-client')));
        ...
        it('should get customer by id successfully', async () => {
            ...
            const { getCustomerById } = await Promise.resolve().then(() => __importStar(require('../api-client')));
        ...
        it('should save new customer successfully', async () => {
            ...
            const { saveCustomer } = await Promise.resolve().then(() => __importStar(require('../api-client')));
            await saveCustomer(newCustomer);
            expect(mockFetch).toHaveBeenCalledTimes(1);
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/customers'), expect.objectContaining({
                method: 'POST',
            }));
        });
        ...
        it('should delete customer successfully', async () => {
            ...
            const { deleteCustomer } = await Promise.resolve().then(() => __importStar(require('../api-client')));
            await deleteCustomer('1');
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/customers/1'), expect.objectContaining({
                method: 'DELETE',
            }));
        });
    });
    describe('Vehicle Transactions', () => {
        it('should get all vehicle transactions successfully', async () => {
            ...
            const { getAllVehicleTransactions } = await Promise.resolve().then(() => __importStar(require('../api-client')));
        ...
        it('should get vehicle transactions with filters', async () => {
            ...
            expect(result).toEqual(mockTransactions);
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('vehicleId=v1'), expect.anything());
        });
        it('should get vehicle transaction by id successfully', async () => {
            ...
            const { getVehicleTransactionById } = await Promise.resolve().then(() => __importStar(require('../api-client')));
        ...
        it('should save new vehicle transaction successfully', async () => {
            ...
            const { saveVehicleTransaction } = await Promise.resolve().then(() => __importStar(require('../api-client')));
            await saveVehicleTransaction(newTransaction);
            expect(mockFetch).toHaveBeenCalledTimes(1);
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/vehicle-transactions'), expect.objectContaining({
                method: 'POST',
            }));
        });
        it('should delete vehicle transaction successfully', async () => {
            ...
            const { deleteVehicleTransaction } = await Promise.resolve().then(() => __importStar(require('../api-client')));
            await deleteVehicleTransaction('1');
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/vehicle-transactions/1'), expect.objectContaining({
                method: 'DELETE',
            }));
        });
    });
    describe('Expense Categories', () => {
        it('should get all expense categories successfully', async () => {
            ...
            const { getAllExpenseCategories } = await Promise.resolve().then(() => __importStar(require('../api-client')));
        ...
        it('should get expense category by id successfully', async () => {
            ...
            const { getExpenseCategoryById } = await Promise.resolve().then(() => __importStar(require('../api-client')));
        ...
        it('should save expense category successfully', async () => {
            ...
            const { saveExpenseCategory } = await Promise.resolve().then(() => __importStar(require('../api-client')));
            await saveExpenseCategory(category);
            expect(mockFetch).toHaveBeenCalledTimes(1);
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/expense-categories'), expect.objectContaining({
                method: 'POST',
            }));
        });
        it('should delete expense category successfully', async () => {
            ...
            const { deleteExpenseCategory } = await Promise.resolve().then(() => __importStar(require('../api-client')));
            await deleteExpenseCategory('1');
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/expense-categories/1'), expect.objectContaining({
                method: 'DELETE',
            }));
        });
    });
    describe('Vehicle Profitability', () => {
        it('should get vehicle profitability successfully', async () => {
            ...
            const { getVehicleProfitability } = await Promise.resolve().then(() => __importStar(require('../api-client')));
    ...
    describe('Vehicle Finance Dashboard', () => {
        it('should get vehicle finance dashboard successfully', async () => {
            ...
            const { getVehicleFinanceDashboard } = await Promise.resolve().then(() => __importStar(require('../api-client')));
