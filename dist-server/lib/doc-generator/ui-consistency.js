...
exports.DOC_GENERATOR_LABELS = void 0;
exports.toTitleCaseLabel = toTitleCaseLabel;
exports.DOC_GENERATOR_LABELS = {
    quotations: {
...
function toTitleCaseLabel(input, fallback = 'Draft') {
