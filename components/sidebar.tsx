  ...
  return (
    <aside className="w-64 bg-[#001f3f] text-white min-h-screen fixed left-0 top-0 flex flex-col border-r border-blue-800 z-50">
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        ...
        <Link
          href="/"
          className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors text-sm ${isHomeActive
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors text-sm ${isActive('/vehicle-dashboard')
              ? 'bg-blue-600 text-white'
              : 'text-blue-100 hover:bg-blue-900/50'
            }`}
        >
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors text-sm ${isActive('/vehicle-finances')
              ? 'bg-blue-600 text-white'
              : 'text-blue-100 hover:bg-blue-900/50'
            }`}
        >
        ...
        <Link
          href="/payslips"
          className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors text-sm ${isActive('/payslips')
              ? 'bg-blue-600 text-white'
              : 'text-blue-100 hover:bg-blue-900/50'
            }`}
        >
        ...
        {otherNavigationItems.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors text-sm ${active
                  ? 'bg-blue-600 text-white'
                  : 'text-blue-100 hover:bg-blue-900/50'
                }`}
            >
